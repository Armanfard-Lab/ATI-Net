...
class STL(nn.Module):
    '''
    Segnet based model for single task learning (STL)

    source: https://github.com/lorenmt/mtan/blob/master/im2im_pred/model_segnet_single.py
    '''
    def __init__(STL, task, num_out_channels={'semantic': 13, 'depth': 1, 'normal': 3}):
        super(SegNet, self).__init__()
        # initialise network parameters
        filter = [64, 128, 256, 512, 512]
        self.task = task
        self.num_out_channels = num_out_channels
        self.class_nb = num_out_channels['semantic']
